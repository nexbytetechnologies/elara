    ...
    <div className="rounded-3xl border border-[#DDD0C8]/80 bg-white/50 p-7 shadow-xl shadow-[#B76E79]/5 backdrop-blur-xl dark:border-[#3B3236] dark:bg-[#211C1F]/70 md:p-9">
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          {fieldErrors.name?.[0] && (
            <p className="mt-2 text-xs text-[#98505D] dark:text-[#CC8490]">
              {fieldErrors.name[0]}
            </p>
          )}
        </div>
        ...
        <div>
          ...
          {availabilityError && (
            <p className="mb-3 text-sm text-[#98505D] dark:text-[#CC8490]">
              {availabilityError}
            </p>
          )}
        ...
        <p className="text-center text-xs text-[#6E6266] dark:text-[#B9ADB1]">
